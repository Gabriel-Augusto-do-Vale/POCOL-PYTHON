...
for _ in range(13): #LOOP QUANTIDADE DE PÁGINAS A SEREM FEITAS
    ...
    pyautogui.moveTo(1100, 210, duration=0.2)
    pyautogui.click()
    time.sleep(2)
    ...
    for _ in range(18):
        ...
        pyautogui.moveTo(475, 384, duration=0.2)
        pyautogui.scroll(-172)
        time.sleep(0.3)
        pyautogui.click()
        #PROCESSO INICIADO
        #SELECIONA A DESCRICAO
